...
const faqItems = [
    ...
    },
    {
        ...
        answer: "During the 3-day free trial, you get full access to our coal plan features."
    },
    {
        question: "What server locations are available?",
        answer: "We offer server locations in multiple cities across Asia, including Tokyo, Singapore, and Mumbai, to ensure low latency and high performance."
    },
    {
